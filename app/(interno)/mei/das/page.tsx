...
const PALETA = {
  ...
  xms: { OURO: '#101b3d', VERDE: '#16a97d', VERMELHO: '#ff5a6b', AZUL: '#2ecc9b', AMBAR: '#f5a623', ALARANJADO: '#ea580c', NEUTRO: '#6b7280', CAMPO_BG: '#eef2f7', POCO_BG: 'rgba(255,255,255,0.2)' },
} as const
...
export default function DASObrigacoes() {
  ...
  async function salvarDasInline() {
    ...
    if (error || !data || data.length === 0) {
      ...
      Sentry.captureException(new Error(`Falha ao salvar mei_dados: ${motivo}`), { extra: { tabela: 'mei_dados', operacao: 'upsert', motivo } })
      showToast(t('erroSalvarDas'), 'erro')
      return
    }
