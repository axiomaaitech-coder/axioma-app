...
export default function PainelMEI() {
  ...
  const PALETA = {
    ...
    xms: { OURO: '#101b3d', ROYAL: '#2ecc9b', VERDE: '#16a97d', VERMELHO: '#ff5a6b', AMBAR: '#f5a623', AZUL: '#2ecc9b', CAMPO_BG: '#eef2f7', CHIP_BG: 'rgba(16,27,61,0.05)', CHIP_BORDA: 'rgba(16,27,61,0.12)' },
  } as const
