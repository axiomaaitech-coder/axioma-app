...
const PALETA = {
  ...
  xms: { OURO: '#101b3d', VERDE: '#16a97d', VERMELHO: '#ff5a6b', AZUL: '#2ecc9b', ROXO: '#7c3aed', BOLHA_BG: '#ffffff', BOLHA_BORDA: 'rgba(16,27,61,0.12)', CAMPO_BG: '#eef2f7', POCO_BG: '#eef2f7' },
} as const
...
export default function IAMEIAdvisor() {
  ...
  const txt = {
    ...
    transparencia: {
      pt: 'Respostas geradas pela inteligência do Axioma com base nos seus dados reais. Se não for possível responder agora, cai automaticamente para respostas por regra.',
      en: 'Answers generated by Axioma intelligence based on your real data. If it cannot answer right now, it automatically falls back to rule-based answers.',
      es: 'Respuestas generadas por la inteligencia de Axioma con base en sus datos reales. Si no se puede responder ahora, cae automáticamente a respuestas por reglas.',
    },
    sugestoes: {
