...
export default function FaturamentoMEI() {
  ...
  const txt = {
    ...
    analiseIATransparencia: { pt: 'Análise gerada por IA (Claude) com base no seu faturamento real. Se a IA não responder, cai automaticamente para análise por regra.', en: 'Analysis generated by AI (Claude) based on your real revenue. If the AI fails to respond, it automatically falls back to rule-based analysis.', es: 'Análisis generado por IA (Claude) con base en su facturación real. Si la IA no responde, cae automáticamente a análisis por regla.' },
