...
export default function CustosFixos() {
  ...
  const LETREIRO_DESTAQUE = temaClaro ? "#2ecc9b" : ct("#fca5a5");
  ...
  return (
    ...
    <ModuloLayout titulo={t.custosFixos.titulo} subtitulo={t.custosFixos.subtitulo}
              ...
              <table className="w-full min-w-[600px]">
                ...
                <tbody>
                  {custosFiltrados.length === 0 ? (
                    <tr><td colSpan={6} className="text-center py-12 text-sm" style={{ color: TEXTO_SEC }}>{t.custosFixos.semCustos}</td></tr>
      ...
      <CentroCompartilhamento
        ...
        assunto={`${t.custosFixos.titulo} — Axioma`}
