...
export default function Relatorios() {
  ...
  const dreTitle = { pt: "Demonstração do Resultado — Março 2026", en: "Income Statement — March 2026", es: "Estado de Resultados — Marzo 2026" };
  const evolTitle = { pt: "Evolução Financeira 2026", en: "Financial Evolution 2026", es: "Evolución Financiera 2026" };
  const distTitle = { pt: "Distribuição de Custos", en: "Cost Distribution", es: "Distribución de Costos" };
  ...
  const exportarPDF = async () => {
    ...
    try {
      ...
      const nomeArquivo = `axioma-relatorio-${aba}-${new Date().toISOString().slice(0, 10)}.pdf`;
  ...
  return (
    <div className="min-h-screen p-8 overflow-auto" style={{ background: "#020810" }}>
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        >
          <Download size={16} />
          {exportando ? textoExportando[idioma] : textoExportar[idioma]}
        </button>
      </div>
