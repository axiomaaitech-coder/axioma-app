            ...
            <table className="w-full">
              ...
              <tbody>
                {custosFiltrados.length === 0 ? (
                  <tr><td colSpan={6} className="text-center py-12" style={{color: "#3a5a8a"}}>{t.custosVariaveis.semCustos}</td></tr>
                  ...
                  <tr key={c.id} style={{borderBottom: i < custosFiltrados.length - 1 ? "1px solid rgba(59,111,212,0.08)" : "none"}}>
                    ...
                    <td className="px-6 py-4 text-sm font-bold" style={{color: "#6ab0ff"}}>{totalMes > 0 ? ((c.valor / totalMes) * 100).toFixed(1) : "0.0"}%</td>
