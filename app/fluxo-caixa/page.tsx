...
import { ArrowLeft, TrendingUp, TrendingDown, AlertTriangle, Plus, X, Download } from "lucide-react";
            ...
            <table className="w-full">
              ...
              <tbody>
                {lancamentos.length === 0 ? (
                  <tr><td colSpan={5} className="text-center py-12" style={{color: "#3a5a8a"}}>{t.fluxoCaixa.semLancamentos}</td></tr>
                ) : lancamentos.map((l, i) => (
