...
const TEXTOS = {
  pt: {
    ...
    // Painel
    analiseAnual: "Análise Anual", subAnalise: "Evolução · Composição · Previsão Axioma",
    evolucao: "Evolução Mensal", composicao: "Composição por Categoria",
    previsao: "Previsão (próx. 3 meses)", realizado: "Realizado", projetado: "Projeção Axioma",
    // Insights
    ...
    narrativaTitulo: "O que mudou", sugestoesTitulo: "Sugestões Axioma", anomaliasTitulo: "Anomalias Detectadas",
    ...
    simObjetivosTitulo: "Objetivos Rápidos", simObjetivosSub: "Cada botão pré-preenche os choques abaixo — regra determinística do Axioma",
    ...
    simConselhoTitulo: "Conselho Executivo", simConselhoSub: "Resumo, riscos, oportunidades e plano de ação — gerado por regras do Axioma (ver nota de transparência)",
    ...
    prcPainelEspecialistasTitulo: "Painel de Especialistas", prcPainelEspecialistasSub: "Análise por regras determinísticas do Axioma (ver nota de transparência)",
  ...
  en: {
    ...
    analiseAnual: "Annual Analysis", subAnalise: "Evolution · Composition · Axioma Forecast",
    evolucao: "Monthly Evolution", composicao: "Composition by Category",
    previsao: "Forecast (next 3 months)", realizado: "Actual", projetado: "Axioma Forecast",
    ...
    narrativaTitulo: "What changed", sugestoesTitulo: "Axioma Suggestions", anomaliasTitulo: "Detected Anomalies",
    ...
    simObjetivosTitulo: "Quick Objectives", simObjetivosSub: "Each button pre-fills the shocks below — deterministic Axioma rule",
    ...
    simConselhoTitulo: "Executive Advisory", simConselhoSub: "Summary, risks, opportunities and action plan — rule-generated by Axioma (see transparency note)",
    ...
    prcPainelEspecialistasTitulo: "Specialist Panel", prcPainelEspecialistasSub: "Deterministic Axioma rules (see transparency note)",
  ...
  es: {
    ...
    analiseAnual: "Análisis Anual", subAnalise: "Evolución · Composición · Previsión Axioma",
    evolucao: "Evolución Mensual", composicao: "Composición por Categoría",
    previsao: "Previsión (próx. 3 meses)", realizado: "Realizado", projetado: "Previsión Axioma",
    ...
    narrativaTitulo: "Qué cambió", sugestoesTitulo: "Sugerencias de Axioma", anomaliasTitulo: "Anomalías Detectadas",
    ...
    simObjetivosTitulo: "Objetivos Rápidos", simObjetivosSub: "Cada botón precompleta los choques abajo — regla determinística de Axioma",
    ...
    simConselhoTitulo: "Consejo Ejecutivo", simConselhoSub: "Resumen, riesgos, oportunidades y plan de acción — generado por reglas de Axioma (ver nota de transparencia)",
    ...
    prcPainelEspecialistasTitulo: "Panel de Especialistas", prcPainelEspecialistasSub: "Reglas determinísticas de Axioma (ver nota de transparencia)",
