# Graph Report - axioma  (2026-08-01)

## Corpus Check
- 128 files · ~443,323 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1586 nodes · 3839 edges · 104 communities (76 shown, 28 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c71690cc`
...
Cohesion: 0.06
Nodes (33): atualizarContrato(), atualizarInteracao(), avaliarCreditoReforma(), calcularScoreAxiomaFornecedor(), comprasNoPeriodo(), CreditoReformaFornecedor, CriterioScoreAxioma, CurvaABCItem (+25 more)
...
Cohesion: 0.24
Nodes (8): AtualizarSenha(), supabase, Cadastro(), Planos(), supabase, LoginPage(), useLanguage(), createClient()
...
Cohesion: 0.13
Nodes (22): FONTE, IAMEIAdvisor(), supabase, FONTE, PrecificacaoMEI(), supabase, ReformaTributaria(), supabase (+14 more)
...
Cohesion: 0.06
Nodes (32): CorSaude, BucketRecebimento, CardEspecialista, CLASSIFICACAO_LABEL, ClassificacaoCliente, ConselhoExecutivo, CriterioScoreAxiomaCliente, EstagioInadimplencia (+24 more)

### Community 26 - "page.tsx"
Cohesion: 0.07
Nodes (53): CATEGORIAS_CASO, Inadimplencia(), supabase, DRE, FaixaAging, rankingScoreAxiomaCliente(), criarCompromisso(), agruparInadimplenciaPorCampo() (+45 more)

### Community 27 - "TopNav.tsx"
Cohesion: 0.12
Nodes (33): PainelMEI(), supabase, fK(), optBarrasV(), optLinhaMulti(), optRosca(), calcularPenalidadeDASAtraso(), CategoriaMEI (+25 more)
...
Cohesion: 0.15
Nodes (26): formatBRL(), IATributariaPage(), supabase, T, tooltipStyle, AlertaReforma, calcularAliquotaSimples(), calcularCargaTributaria() (+18 more)
...
Cohesion: 0.12
Nodes (16): Agrupador, CentroLeve, ColunaId, COLUNAS, fmt(), Lang, LinhaPlanilha, PlanilhaCentroCusto() (+8 more)

### Community 51 - "fast-xml-parser"
Cohesion: 0.12
Nodes (28): CAT_COR, categorias, CustoFixo, CustosFixos(), supabase, CAT_COR, categorias, CATEGORIAS_RECORRENTES (+20 more)
...
Cohesion: 0.06
Nodes (32): AlertaReposicao, atualizarMovimentacao(), atualizarProduto(), AvisoEstoque, CampoPersonalizadoEmpresa, carregarConfigEstoqueEmpresa(), ComposicaoItem, confirmarRecebimento() (+24 more)
...
### Community 66 - "stripe"
Cohesion: 0.13
Nodes (12): BadgeDestaque(), LABELS, grupos, Sidebar(), supabase, grupos, Idioma, supabase (+4 more)
...
Cohesion: 0.27
Nodes (10): abrirExcecaoFormatoReforma(), abrirExcecoes(), atualizarPadroesClassificacao(), criarImportacao(), deletarLinhaImportada(), editarLinhaImportada(), gravarLinhas(), recalcularTotaisImportacao() (+2 more)

### Community 73 - "xlsx"
Cohesion: 0.08
Nodes (24): Fornecedores(), optRadar(), radarRenovacoes(), atualizarContato(), atualizarDocumentoFornecedor(), criarContato(), criarContrato(), criarDocumentoFornecedor() (+16 more)
...
Cohesion: 0.15
Nodes (14): CATEGORIAS, FaturamentoMEI(), FONTE, Receita, supabase, FONTE, ImpostoRendaMEI(), supabase (+6 more)
...
Cohesion: 0.09
Nodes (40): CAT_COR, categorias, CustosVariaveis(), CustoVariavel, inicioJanelaHistorica(), supabase, fimJanelaFutura(), FluxoCaixa() (+32 more)
...
Cohesion: 0.09
Nodes (24): scoreRecebimento(), AlertaCobranca, atualizarCompromisso(), atualizarStatusCompromisso(), CANAIS_REGUA, CardExplicativo, CobrancaCompromisso, criarInteracao() (+16 more)

### Community 85 - "page.tsx"
Cohesion: 0.07
Nodes (27): EstoquePage(), moeda(), margemReal(), optBarrasComparativo(), optBarrasH(), adicionarCampoPersonalizado(), buscarProdutoPorCodigo(), calcularAlertasReposicao() (+19 more)
...
### Community 91 - "xlsx"
Cohesion: 0.09
Nodes (36): STATUS_INFO, supabase, T, crypto-js, Builder, BUILDERS, buscarCandidatosPorTabela(), buscarImportacaoPorHash() (+28 more)

### Community 92 - "page.tsx"
Cohesion: 0.25
Nodes (8): DASObrigacoes(), FONTE, pad(), supabase, carregarObrigacoesAno(), ObrigacaoMEI, salvarObrigacao(), StatusObrigacao
...
Cohesion: 0.50
Nodes (4): consultarCEP(), formatarCEP(), formatarCPF(), validarCPF()

## Knowledge Gaps
- **525 isolated node(s):** `CATEGORIAS_CUSTOS_FIXOS`, `CATEGORIAS_CUSTOS_VARIAVEIS`, `CATEGORIAS_CONTAS_PAGAR`, `supabase`, `Centro` (+520 more)
...
- **Why does `useLanguage()` connect `useLanguage` to `page.tsx`, `page.tsx`, `page.tsx`, `gerarPdfTabela`, `page.tsx`, `ModuloLayout.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `LanguageContext.tsx`, `page.tsx`, `DashComercial.tsx`, `page.tsx`, `TopNav.tsx`, `page.tsx`, `page.tsx`, `cfoTextos.ts`, `fast-xml-parser`, `framer-motion`, `html2canvas`, `ofx-js`, `pluggy-sdk`, `stripe`, `xlsx`, `page.tsx`, `page.tsx`, `DashFinanceiro.tsx`, `page.tsx`, `xlsx`, `page.tsx`, `page.tsx`?**
  _High betweenness centrality (0.121) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `page.tsx`, `lucide-react`, `next`, `posthog-js`, `page.tsx`, `@supabase/ssr`, `@supabase/supabase-js`, `three`, `DashComercial.tsx`, `montarSnapshotsCarteira`, `simulacaoMonteCarlo`, `echarts`, `echarts-for-react`, `xlsx`, `xlsx`, `etiquetaHelpers.ts`, `pluggy-sdk`, `recharts`, `@stripe/stripe-js`, `echarts-for-react`?**
