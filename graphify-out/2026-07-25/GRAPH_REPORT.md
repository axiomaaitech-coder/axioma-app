# Graph Report - axioma  (2026-07-25)

## Corpus Check
- 109 files · ~409,898 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1413 nodes · 3353 edges · 94 communities (64 shown, 30 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d0a953c4`
...
3. `fBRL()` - 57 edges
4. `🦅 AXIOMA — RELATÓRIO DE ONDE PARAMOS` - 47 edges
5. `cfoT()` - 41 edges
6. `DREPage()` - 38 edges
7. `fPct()` - 38 edges
8. `gerarPdfTabela()` - 38 edges
9. `Metas()` - 37 edges
...
Cohesion: 0.06
Nodes (48): EmpresaPage(), formatBRL(), formatData(), formatDataHora(), PORTES, supabase, T, grupos (+40 more)
...
Cohesion: 0.09
Nodes (47): CAT_COR, categorias, CustosVariaveis(), CustoVariavel, inicioJanelaHistorica(), supabase, fimJanelaFutura(), FluxoCaixa() (+39 more)
...
Cohesion: 0.07
Nodes (35): primeiroRegistroAuditoria(), analisarCausaRaiz(), atualizarPlanoAcao(), AUTOR_NAO_REGISTRADO, BaselineSimulacao, CausaRaizItem, CentralInsights, CentroLeve (+27 more)
...
Cohesion: 0.06
Nodes (54): Fornecedores(), formatarTelefone(), atualizarContato(), atualizarContrato(), atualizarDocumentoFornecedor(), atualizarInteracao(), atualizarProduto(), avaliarCreditoReforma() (+46 more)
...
Cohesion: 0.13
Nodes (25): Divida, Endividamento(), inicioJanelaHistorica(), inicioRolling12(), mesesNoPeriodo(), supabase, tipos, calcularSinaisSolvencia() (+17 more)
...
Cohesion: 0.07
Nodes (26): categorias, CODIGOS_PAISES, ContaPagar, contaVazia, EtapaCadastro, ETAPAS_CADASTRO, formasPagamento, Fornecedor (+18 more)
...
Cohesion: 0.11
Nodes (27): CAT_COR, categorias, CustoFixo, CustosFixos(), supabase, CAT_COR, categorias, CATEGORIAS_RECORRENTES (+19 more)
...
Cohesion: 0.17
Nodes (20): ConcorrenteRow, DecisaoRow, Precificacao(), ProdutoRow, supabase, WAR_PRESETS, CanvasBox(), calcularImpactoDesconto() (+12 more)
...
Cohesion: 0.09
Nodes (30): CATEGORIAS_CONTAS_PAGAR, CATEGORIAS_CUSTOS_FIXOS, CATEGORIAS_CUSTOS_VARIAVEIS, Centro, CentrosCustoPage(), CORES_CENTRO, getCor(), inputStyle (+22 more)

### Community 60 - "ofx-js"
Cohesion: 0.10
Nodes (33): corTipo, inicioJanela24m(), inicioRolling12(), InvestimentoRow, Investimentos(), mesesNoPeriodo(), optBarrasPct(), supabase (+25 more)
...
### Community 73 - "xlsx"
Cohesion: 0.67
Nodes (3): calcularScoreAxiomaFornecedor(), rankingScoreAxioma(), TIPOS_DOC_COMPLIANCE
...
## Knowledge Gaps
- **476 isolated node(s):** `CATEGORIAS_CUSTOS_FIXOS`, `CATEGORIAS_CUSTOS_VARIAVEIS`, `CATEGORIAS_CONTAS_PAGAR`, `supabase`, `Centro` (+471 more)
...
- **Why does `gerarPdfTabela()` connect `page.tsx` to `page.tsx`, `page.tsx`, `page.tsx`, `gerarPdfTabela`, `page.tsx`, `ModuloLayout.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `DashComercial.tsx`, `page.tsx`, `cfoTextos.ts`, `Fornecedores`, `fast-xml-parser`, `framer-motion`, `montarDRE`, `html2canvas`, `ofx-js`, `page.tsx`, `xlsx`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `lucide-react`, `next`, `pluggy-sdk`, `posthog-js`, `page.tsx`, `@supabase/ssr`, `@supabase/supabase-js`, `three`, `DashComercial.tsx`, `page.tsx`, `montarSnapshotsCarteira`, `page.tsx`, `simulacaoMonteCarlo`, `echarts`, `page.tsx`, `echarts-for-react`, `fast-xml-parser`, `xlsx`, `xlsx`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `useLanguage()` connect `useLanguage` to `page.tsx`, `page.tsx`, `page.tsx`, `gerarPdfTabela`, `page.tsx`, `ModuloLayout.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `LanguageContext.tsx`, `page.tsx`, `DashComercial.tsx`, `page.tsx`, `TopNav.tsx`, `page.tsx`, `page.tsx`, `cfoTextos.ts`, `fast-xml-parser`, `framer-motion`, `montarDRE`, `html2canvas`, `ofx-js`, `stripe`, `page.tsx`, `DashFinanceiro.tsx`, `xlsx`, `page.tsx`?**
