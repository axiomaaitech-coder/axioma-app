# Graph Report - axioma  (2026-07-24)

## Corpus Check
- 108 files · ~397,494 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1373 nodes · 3274 edges · 92 communities (63 shown, 29 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `18b9f571`
...
7. `🦅 AXIOMA — RELATÓRIO DE ONDE PARAMOS` - 38 edges
8. `DREPage()` - 37 edges
9. `ClientesPage()` - 36 edges
10. `Metas()` - 36 edges
...
Cohesion: 0.08
Nodes (43): EmpresaPage(), formatBRL(), formatData(), formatDataHora(), PORTES, supabase, T, atualizarEmpresa() (+35 more)

### Community 1 - "page.tsx"
Cohesion: 0.07
Nodes (61): DESTINOS, formatBRL(), formatDataHora(), HistoricoBlock(), ImportarDocumentosPage(), PreviewBlock(), STATUS_INFO, supabase (+53 more)

### Community 2 - "page.tsx"
Cohesion: 0.07
Nodes (39): BigBarPanel(), COR, CORES_COMP, CORES_DIST, DashboardPage(), DonutPanel(), fBRL(), supabase (+31 more)
...
Cohesion: 0.06
Nodes (37): amostraTriangular(), analiseSensibilidade(), BucketLiquidez, BucketSemanal, CapitalOcioso, CenarioQuitacao, ChaveRiscoInvestimento, ClassificacaoMeta (+29 more)
...
Cohesion: 0.11
Nodes (34): CAT_COR, categorias, CustoFixo, CustosFixos(), supabase, CAT_COR, categorias, CATEGORIAS_RECORRENTES (+26 more)
...
Cohesion: 0.07
Nodes (35): primeiroRegistroAuditoria(), analisarCausaRaiz(), AUTOR_NAO_REGISTRADO, CausaRaizItem, CentralInsights, CentroLeve, Complexidade, COMPLEXIDADE_TIPO (+27 more)
...
Cohesion: 0.07
Nodes (31): avaliarCreditoReforma(), calcularScoreAxiomaFornecedor(), CreditoReformaFornecedor, CriterioScoreAxioma, CurvaABCItem, excluirInteracao(), FornecedorContato, FornecedorContrato (+23 more)

### Community 12 - "page.tsx"
Cohesion: 0.10
Nodes (29): categoriasCustoFixo, categoriasReceita, ContaReceberRow, CustoFixoRow, CustoVarRow, DividaRow, DREPage(), FluxoCaixaRow (+21 more)

### Community 13 - "🦅 AXIOMA — RELATÓRIO DE ONDE PARAMOS"
Cohesion: 0.05
Nodes (36): 11. MIGRAÇÃO MULTI-TENANT — arquivo entregue (2026-07-23), 12. EMPRESA PADRÃO AUTOMÁTICA — pré-requisito da tela de aceitar convite (decidido 2026-07-23), 13. PARTE 6 DA MIGRAÇÃO MULTI-TENANT — ajuste de código, COMPLETA (2026-07-23), 1. RESUMO EM UMA FRASE, 2. O ALICERCE (já construído e funcionando), 3-A. Metas (`/metas`) — CONECTADO a dados reais, entregue nesta rodada, 3-B. Investimentos (`/investimentos`) — CONECTADO a dados reais, Fase 1 entregue nesta rodada, 3-C. Simulações (`/simulacoes`) — reescrito do zero, entregue nesta rodada (+28 more)
...
Cohesion: 0.09
Nodes (42): CAT_COR, categorias, CustosVariaveis(), CustoVariavel, inicioJanelaHistorica(), supabase, fimJanelaFutura(), FluxoCaixa() (+34 more)
...
Cohesion: 0.06
Nodes (55): CATEGORIAS_CASO, Inadimplencia(), supabase, DRE, ClienteRow, FaixaAging, criarInteracao(), gerarParecerCobranca() (+47 more)
...
Cohesion: 0.11
Nodes (19): @anthropic-ai/sdk, fast-xml-parser, framer-motion, @gsap/react, dependencies, @anthropic-ai/sdk, fast-xml-parser, framer-motion (+11 more)
...
Cohesion: 0.07
Nodes (50): inicioJanela12m(), mesesNoPeriodo(), RegimeSimulado, ResultadoSimulacao, ResultadoTributario, Simulacoes(), supabase, ArvoreMeta (+42 more)
...
Cohesion: 0.08
Nodes (41): corTipo, inicioJanela24m(), inicioRolling12(), InvestimentoRow, Investimentos(), mesesNoPeriodo(), optBarrasPct(), supabase (+33 more)

### Community 52 - "framer-motion"
Cohesion: 0.11
Nodes (28): CATEGORIAS, CentroCusto, COLUNAS_PENDENTES_SQL, Conta, ContasReceber(), contaVazia, FORMAS_RECEBIMENTO, PRIORIDADES (+20 more)
...
Cohesion: 0.09
Nodes (33): CATEGORIAS_CONTAS_PAGAR, CATEGORIAS_CUSTOS_FIXOS, CATEGORIAS_CUSTOS_VARIAVEIS, Centro, CentrosCustoPage(), CORES_CENTRO, getCor(), inputStyle (+25 more)

### Community 63 - "react"
Cohesion: 0.09
Nodes (24): ClienteSnapshot, ContaRow, Idioma3, ScoreAxiomaCliente, SnapshotCarteira, agruparCarteiraPorCampo(), AlavancasRecebimento, BaseSimuladorRecebimento (+16 more)
...
Cohesion: 0.08
Nodes (25): Fornecedores(), nomesPaises(), optRadar(), formatarTelefone(), atualizarContato(), atualizarContrato(), atualizarDocumentoFornecedor(), atualizarProduto() (+17 more)
...
Cohesion: 0.10
Nodes (22): scoreRecebimento(), AlertaCobranca, atualizarCompromisso(), atualizarStatusCompromisso(), CANAIS_REGUA, CardExplicativo, CobrancaInteracao, criarCompromisso() (+14 more)

### Community 84 - "echarts"
Cohesion: 0.40
Nodes (5): identificarOportunidades(), detectarDesperdicio(), contratosVencendo(), oportunidadesConsolidacao(), precoAcimaMediaInterna()
...
## Knowledge Gaps
- **455 isolated node(s):** `CATEGORIAS_CUSTOS_FIXOS`, `CATEGORIAS_CUSTOS_VARIAVEIS`, `CATEGORIAS_CONTAS_PAGAR`, `supabase`, `Centro` (+450 more)
...
- **Why does `gerarPdfTabela()` connect `page.tsx` to `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `gerarPdfTabela`, `ModuloLayout.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `DashComercial.tsx`, `page.tsx`, `cfoTextos.ts`, `Fornecedores`, `fast-xml-parser`, `framer-motion`, `montarDRE`, `html2canvas`, `page.tsx`, `montarSnapshotsCarteira`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `page.tsx`, `lucide-react`, `next`, `ofx-js`, `pluggy-sdk`, `posthog-js`, `stripe`, `page.tsx`, `@supabase/ssr`, `@supabase/supabase-js`, `three`, `@types/three`, `xlsx`, `page.tsx`, `page.tsx`, `simulacaoMonteCarlo`, `page.tsx`, `echarts-for-react`, `html2canvas`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `jspdf` connect `page.tsx` to `page.tsx`, `fast-xml-parser`, `TopNav.tsx`, `dependencies`, `page.tsx`?**
