# Graph Report - axioma  (2026-07-26)

## Corpus Check
- 109 files · ~411,447 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1417 nodes · 3357 edges · 96 communities (67 shown, 29 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f56d89ab`
...
3. `fBRL()` - 57 edges
4. `🦅 AXIOMA — RELATÓRIO DE ONDE PARAMOS` - 51 edges
5. `cfoT()` - 41 edges
6. `DREPage()` - 38 edges
7. `fPct()` - 38 edges
...
Cohesion: 0.07
Nodes (32): primeiroRegistroAuditoria(), analisarCausaRaiz(), atualizarPlanoAcao(), AUTOR_NAO_REGISTRADO, CausaRaizItem, CentralInsights, CentroLeve, Complexidade (+24 more)
...
Cohesion: 0.07
Nodes (31): atualizarDocumentoFornecedor(), atualizarProduto(), calcularScoreAxiomaFornecedor(), comprasNoPeriodo(), CreditoReformaFornecedor, criarContato(), criarDocumentoFornecedor(), CriterioScoreAxioma (+23 more)
...
Cohesion: 0.06
Nodes (57): CATEGORIAS_CASO, Inadimplencia(), supabase, Props, optVelocimetro(), Periodo, PeriodoPreset, FaixaAging (+49 more)
...
Cohesion: 0.11
Nodes (19): @anthropic-ai/sdk, framer-motion, @gsap/react, dependencies, @anthropic-ai/sdk, framer-motion, @gsap/react, pluggy-sdk (+11 more)
...
Cohesion: 0.13
Nodes (17): Agrupador, CentroLeve, ColunaId, COLUNAS, fmt(), Lang, LinhaPlanilha, PlanilhaCentroCusto() (+9 more)

### Community 51 - "fast-xml-parser"
Cohesion: 0.08
Nodes (55): CAT_COR, categorias, CustoFixo, CustosFixos(), supabase, CAT_COR, categorias, CustosVariaveis() (+47 more)
...
### Community 60 - "ofx-js"
Cohesion: 0.10
Nodes (31): corTipo, inicioJanela24m(), inicioRolling12(), InvestimentoRow, Investimentos(), mesesNoPeriodo(), optBarrasPct(), supabase (+23 more)
...
Cohesion: 0.12
Nodes (17): aplicarRateio(), atualizarCampoOrigem(), AuditoriaRow, carregarAuditoriaCentro(), carregarLancamentosOrigem(), carregarOrcamentos(), carregarRateios(), carregarReceitasOrigem() (+9 more)
...
### Community 73 - "xlsx"
Cohesion: 0.09
Nodes (23): Fornecedores(), nomesPaises(), atualizarContato(), atualizarContrato(), atualizarInteracao(), avaliarCreditoReforma(), criarContrato(), criarInteracao() (+15 more)
...
Cohesion: 0.10
Nodes (22): scoreRecebimento(), AlertaCobranca, atualizarCompromisso(), CANAIS_REGUA, CardExplicativo, CobrancaCompromisso, criarInteracao(), detectarAlertasCobranca() (+14 more)

### Community 85 - "page.tsx"
Cohesion: 0.50
Nodes (4): identificarOportunidades(), contratosVencendo(), oportunidadesConsolidacao(), precoAcimaMediaInterna()
...
### Community 94 - "enderecoHelpers.ts"
Cohesion: 0.50
Nodes (3): DadosCEP, formatarCPF(), validarCPF()

## Knowledge Gaps
- **480 isolated node(s):** `CATEGORIAS_CUSTOS_FIXOS`, `CATEGORIAS_CUSTOS_VARIAVEIS`, `CATEGORIAS_CONTAS_PAGAR`, `supabase`, `Centro` (+475 more)
...
- **Why does `dependencies` connect `dependencies` to `lucide-react`, `next`, `pluggy-sdk`, `posthog-js`, `page.tsx`, `@supabase/ssr`, `@supabase/supabase-js`, `three`, `DashComercial.tsx`, `page.tsx`, `montarSnapshotsCarteira`, `page.tsx`, `simulacaoMonteCarlo`, `echarts`, `echarts-for-react`, `fast-xml-parser`, `xlsx`, `xlsx`, `echarts`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `useLanguage()` connect `useLanguage` to `page.tsx`, `page.tsx`, `page.tsx`, `cfoCore.ts`, `gerarPdfTabela`, `page.tsx`, `ModuloLayout.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `LanguageContext.tsx`, `page.tsx`, `DashComercial.tsx`, `page.tsx`, `TopNav.tsx`, `page.tsx`, `page.tsx`, `cfoTextos.ts`, `fast-xml-parser`, `framer-motion`, `montarDRE`, `html2canvas`, `ofx-js`, `stripe`, `xlsx`, `page.tsx`, `DashFinanceiro.tsx`, `xlsx`, `page.tsx`?**
