...
## Corpus Check
- 129 files · ~443,458 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1592 nodes · 3900 edges · 95 communities (68 shown, 27 thin omitted)
...
Cohesion: 0.40
Nodes (4): Props, SeletorPeriodo(), Periodo, PeriodoPreset
...
Cohesion: 0.07
Nodes (33): primeiroRegistroAuditoria(), analisarCausaRaiz(), AUTOR_NAO_REGISTRADO, CausaRaizItem, CentralInsights, CentroLeve, Complexidade, COMPLEXIDADE_TIPO (+25 more)
...
Cohesion: 0.07
Nodes (53): CATEGORIAS_CASO, Inadimplencia(), supabase, DRE, FaixaAging, rankingScoreAxiomaCliente(), CobrancaCompromisso, agruparInadimplenciaPorCampo() (+45 more)

### Community 27 - "TopNav.tsx"
Cohesion: 0.05
Nodes (91): AtualizarSenha(), supabase, DASObrigacoes(), FONTE, pad(), supabase, CATEGORIAS, FaturamentoMEI() (+83 more)
...
Cohesion: 0.11
Nodes (19): @anthropic-ai/sdk, echarts-for-react, fast-xml-parser, framer-motion, @gsap/react, dependencies, @anthropic-ai/sdk, echarts-for-react (+11 more)
...
Cohesion: 0.12
Nodes (30): CAT_COR, categorias, CustoFixo, CustosFixos(), supabase, CAT_COR, categorias, CATEGORIAS_RECORRENTES (+22 more)
...
### Community 66 - "stripe"
Cohesion: 0.05
Nodes (36): Cadastro(), geistMono, geistSans, metadata, viewport, LoginPage(), BadgeDestaque(), LABELS (+28 more)
...
Cohesion: 0.09
Nodes (46): CAT_COR, categorias, CustosVariaveis(), CustoVariavel, inicioJanelaHistorica(), supabase, fimJanelaFutura(), FluxoCaixa() (+38 more)

### Community 83 - "montarSnapshotsCarteira"
Cohesion: 0.09
Nodes (24): scoreRecebimento(), AlertaCobranca, atualizarCompromisso(), atualizarStatusCompromisso(), CardExplicativo, CobrancaInteracao, criarInteracao(), detectarAlertasCobranca() (+16 more)
...
## Knowledge Gaps
- **526 isolated node(s):** `CATEGORIAS_CUSTOS_FIXOS`, `CATEGORIAS_CUSTOS_VARIAVEIS`, `CATEGORIAS_CONTAS_PAGAR`, `supabase`, `Centro` (+521 more)
...
- **Why does `useLanguage()` connect `TopNav.tsx` to `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `ModuloLayout.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `DashComercial.tsx`, `page.tsx`, `page.tsx`, `cfoTextos.ts`, `fast-xml-parser`, `framer-motion`, `html2canvas`, `ofx-js`, `pluggy-sdk`, `stripe`, `xlsx`, `page.tsx`, `page.tsx`, `xlsx`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `page.tsx`, `TopNav.tsx`, `lucide-react`, `next`, `posthog-js`, `page.tsx`, `@supabase/ssr`, `@supabase/supabase-js`, `three`, `DashComercial.tsx`, `montarSnapshotsCarteira`, `simulacaoMonteCarlo`, `echarts`, `echarts-for-react`, `xlsx`, `xlsx`, `etiquetaHelpers.ts`, `pluggy-sdk`, `recharts`, `@stripe/stripe-js`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `jspdf` connect `TopNav.tsx` to `dependencies`, `etiquetaHelpers.ts`?**
