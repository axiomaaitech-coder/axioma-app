...
7. **Cada módulo com COR DE TEMA DIFERENTE** no dashboard (não repetir): Receitas=roxo, Custos Fixos=vermelho/laranja, Custos Variáveis=laranja/âmbar, Fluxo de Caixa=cyan/azul, DRE=verde/teal, Endividamento=rosa/magenta, Metas=roxo/dourado, Investimentos=azul-royal/dourado, Simulações=índigo/prata.
...
## 🔜 PRÓXIMO NA FILA
Precificação (fecha o menu Crescimento) → Comercial (Clientes, Fornecedores, Contas a Receber, Inadimplência) → E-commerce/PDV (alta prioridade — 2 clientes esperando). Perguntar ao Elias a ordem antes de começar. Ver `STATUS-AXIOMA.md` seção 3-C e 4.
...
Clientes, Fornecedores, Contas a Receber, Inadimplência, Centros de Custo, Precificação, Planos, MEI (6 submódulos), Importar Documentos. Já em padrão CFO: IA Financeira, IA Tributária, Empresa, Relatórios, Fluxo de Caixa, DRE, Endividamento, Metas, Investimentos, Simulações.
