...
## 🔜 PRÓXIMO NA FILA
Simulações, Precificação (resto do menu Crescimento) → Comercial (Clientes, Fornecedores, Contas a Receber, Inadimplência) → E-commerce/PDV (alta prioridade — 2 clientes esperando). Perguntar ao Elias a ordem antes de começar. Ver `STATUS-AXIOMA.md` seção 3-B e 4.
