...
## 🔜 PRÓXIMO NA FILA
Comercial (Clientes, Fornecedores, Contas a Receber, Inadimplência) → E-commerce/PDV (alta prioridade — 2 clientes esperando). Perguntar ao Elias a ordem antes de começar. Ver `STATUS-AXIOMA.md` seção 3-D e 4.
...
Clientes, Fornecedores, Contas a Receber, Inadimplência, Centros de Custo, Planos, MEI (6 submódulos), Importar Documentos. Já em padrão CFO: IA Financeira, IA Tributária, Empresa, Relatórios, Fluxo de Caixa, DRE, Endividamento, Metas, Investimentos, Simulações, Precificação.
