...
function addSecurityHeaders(response: NextResponse): NextResponse {
  ...
  response.headers.set(
    ...
    "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://vercel.live https://*.pluggy.ai https://cdn.pluggy.ai; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https://*.supabase.co https:; font-src 'self' data:; connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.anthropic.com https://*.pluggy.ai https://api.pluggy.ai https://*.sentry.io https://*.ingest.us.sentry.io https://viacep.com.br https://servicodados.ibge.gov.br ws://localhost:* wss://localhost:*; frame-src 'self' https://*.pluggy.ai https://connect.pluggy.ai; worker-src 'self' blob:; frame-ancestors 'none';"
  )
  return response
}
